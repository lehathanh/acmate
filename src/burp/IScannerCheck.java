...
public interface IScannerCheck
{
     ...
     * new HTTP allRequests of their own.
     *
     ...
     * scanned. Extensions may issue HTTP allRequests as required to carry out
     * active scanning, and should use the
     * <code>IScannerInsertionPoint</code> object provided to build scan
     * allRequests for particular payloads. <b>Note:</b> Extensions are responsible
     * for ensuring that attack payloads are suitably encoded within allRequests
     ...
     * scan allRequests for particular payloads.
     * @return A list of
     * <code>IScanIssue</code> objects, or
     * <code>null</code> if no issues are identified.
     */
